...
print("Please open an issue if Acro Lash requires context")
        ...
        messages=[
            {
                ...
                "content": "You are a player in a game called quiplash."
                           ...
                           "This is acro lash, you will be provided with three letters, make a funny acronym with these three letters"
